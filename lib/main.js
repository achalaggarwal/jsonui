...
var createArchive = function(input, currentPath, callback) {
  ...
  if (process.platform == 'darwin') {
    zipCommand = "pushd .; cd " + currentPath + "/..; zip -r " + input.appname + " " + input.appname + "; rm -rf " + currentPath + "; popd";
  }
  else {
    zipCommand = "pushd .; cd " + currentPath + "/..; 7za -tzip " + input.appname + ".zip " + input.appname + "; rm -rf " + currentPath + "; popd";
  }
